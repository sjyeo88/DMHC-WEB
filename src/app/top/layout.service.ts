...
export class Layout {
  ...
  public submenus = {
    ...
    dmhc: {title: '매일마음관리',
      ...
      urls:   ['/dmhc/intro', '/dmhc/process',  '/dmhc/accessterm', ],
    },
    lecture: {title: '심리교육 설정',
      menus:  ['전체 교육 정보보기', '새 심리교육 생성하기', '기존교육 수정하기', '심리교육설정 메뉴얼'],
      urls:   ['/lecture/all', '/lecture/new', '/lecture/edit', '/lecture/manual'],
    },
    survey:  {title: '설문지 설정',
      menus: ['새 설문지 작성하기', '기존 설문지 수정하기', '설문지 설정 메뉴얼'],
      urls:   ['/survey/new', '/survey/edit', '/survey/manual', ],
    },
    assign: {title: '내담자 과제설정',
      menus:  ['전체 과제 정보보기', '새 과제 생성하기', '기존 과제 수정하기', 'Hash Tag 설정하기', '과제 설정 메뉴얼'],
      urls:   ['/assign/all', '/assign/new', '/assign/edit', '/assign/hash', '/assign/manual'],
    },
    manage: {title: '내담자 관리',
      menus:  ['전체 내담자 정보관리', '특정 내담자 정보보기', '내담자 관리 메뉴얼'],
      urls:   ['/manage/all', '/manage/detail', '/manage/manual', ],
    },
