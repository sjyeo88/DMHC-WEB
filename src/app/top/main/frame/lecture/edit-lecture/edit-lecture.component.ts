...
export class EditLectureComponent extends LectureComponent {
  ...
  ngOnInit() {
    ...
    this.lay.currentPage = this.lay.submenus.lecture.menus[2];
    this.lay.cuTitle.title = this.lay.submenus.lecture.title
    this.lay.cuTitle.page =  this.lay.submenus.lecture.menus[2];
